...
txtContact = Entry(entries_frame, textvariable=contact, font=("Calibri", 16), width=30,bg="#02011c", fg="white")
...
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=15, font=("Calibri", 16, "bold"), fg="white",
                bg="#16a085",activebackground="white", activeforeground="#16a085", bd=0).grid(row=0, column=0)
